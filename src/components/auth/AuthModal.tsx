...
import { Hexagon, X, Mail, Lock, ShieldCheck, Github, Smartphone } from 'lucide-react';
        ...
        <div className="animate-in fade-in zoom-in-95 duration-200">
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-3">
              <button onClick={() => handleMockLogin('client')} className="flex items-center justify-center gap-2 py-2 px-4 bg-zinc-900 hover:bg-zinc-800 border border-zinc-800 rounded-xl text-sm font-medium text-zinc-300 transition-colors">
              ...
              <button onClick={() => handleMockLogin('freelancer')} className="flex items-center justify-center gap-2 py-2 px-4 bg-zinc-900 hover:bg-zinc-800 border border-zinc-800 rounded-xl text-sm font-medium text-zinc-300 transition-colors">
