...
export const AuthModal: React.FC<Props> = ({ isOpen, onClose }) => {
      ...
      return (
        <div className="animate-in fade-in zoom-in-95 duration-200">
          ...
          <div className="space-y-4">
            <div>
              ...
              <div className="relative">
                ...
                <input 
                  ...
                  className="w-full pl-10 pr-4 py-2.5 bg-zinc-900/50 border border-zinc-800 rounded-xl text-sm text-white focus:outline-none focus:border-emerald-500 focus:ring-1 focus:ring-emerald-500 transition-all"
                />
              </div>
            </div>
            ...
            <button 
              onClick={() => handleMockLogin('client')} // Default mock
              className="w-full py-2.5 bg-emerald-500 hover:bg-emerald-400 text-black font-bold rounded-xl transition-all shadow-[0_0_15px_rgba(16,185,129,0.3)] hover:shadow-[0_0_25px_rgba(16,185,129,0.5)]"
            >
              Sign In
            </button>
            ...
            <div className="grid grid-cols-2 gap-3">
              <button onClick={() => handleOAuthStart('google', 'client')} className="flex items-center justify-center gap-2 py-2.5 px-4 bg-zinc-900 hover:bg-zinc-800 border border-zinc-800 rounded-xl text-sm font-medium text-zinc-300 transition-colors hover:border-emerald-500/40">
              ...
              <button onClick={() => handleOAuthStart('github', 'freelancer')} className="flex items-center justify-center gap-2 py-2.5 px-4 bg-zinc-900 hover:bg-zinc-800 border border-zinc-800 rounded-xl text-sm font-medium text-zinc-300 transition-colors hover:border-emerald-500/40">
        ...
        <div className="animate-in fade-in slide-in-from-right-4 duration-300">
          ...
          <div className="grid gap-4 mb-6">
            <button 
              ...
              className={`p-4 rounded-xl border text-left transition-all ${selectedRole === 'client' ? 'bg-emerald-500/10 border-emerald-500 ring-1 ring-emerald-500/50' : 'bg-zinc-900/50 border-zinc-800 hover:border-zinc-700'}`}
            >
              <div className="flex justify-between items-start">
                ...
                <div className={`w-5 h-5 rounded-full border flex items-center justify-center ${selectedRole === 'client' ? 'border-emerald-500 bg-emerald-500' : 'border-zinc-600'}`}>
            ...
            <button 
              ...
              className={`p-4 rounded-xl border text-left transition-all ${selectedRole === 'freelancer' ? 'bg-emerald-500/10 border-emerald-500 ring-1 ring-emerald-500/50' : 'bg-zinc-900/50 border-zinc-800 hover:border-zinc-700'}`}
            >
              <div className="flex justify-between items-start">
                <div>
                ...
                <div className={`w-5 h-5 rounded-full border flex items-center justify-center ${selectedRole === 'freelancer' ? 'border-emerald-500 bg-emerald-500' : 'border-zinc-600'}`}>
          ...
          <button 
            ...
            onClick={() => setStep('otp')}
            className="w-full py-2.5 bg-emerald-500 hover:bg-emerald-400 disabled:opacity-50 disabled:cursor-not-allowed text-black font-bold rounded-xl transition-all"
          >
            Create Account
          </button>
      ...
      return (
        <div className="animate-in fade-in slide-in-from-right-4 duration-300 text-center">
          ...
          <button 
            ...
            className="w-full py-2.5 bg-emerald-500 hover:bg-emerald-400 text-black font-bold rounded-xl transition-all mb-4"
          >
            Verify & Continue
          </button>
          
          <button onClick={() => setStep('signup_role')} className="text-xs text-zinc-500 hover:text-white">
            Back
          </button>
        </div>
      );
    ...
    if (step === 'oauth_success') {
      return (
        <div className="animate-in fade-in duration-200 text-center py-8">
          ...
          <button onClick={handleOAuthComplete}
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-md bg-[#121215] border border-zinc-800 rounded-3xl shadow-2xl overflow-hidden shadow-emerald-900/10">
